...
- **Numbering:** directive/ADR/volume numbers are governed by
  [`numbering.md`](./numbering.md). ADRs referenced here (0001–0009) live in
  [`../decisions/`](../decisions/); the next free ADR number is **0010** (ADR `0008`, the
  AI SDK Envelope under D-04 / #014, and ADR `0009`, the SDK executor + apply-on-approval
  runtime, are both **Accepted**; with Phase C merged, contract #3 has **graduated Partial →
  Established** and Directive #014 is **complete**).
