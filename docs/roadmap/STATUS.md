...
**Production `main`:** `04bd78ba` — verified against `/api/health`, not inferred
**Production migration tip:** `20261105` — read from `supabase_migrations.schema_migrations`, NOT inferred
...
| `20261106`–`20261108` | ALLOCATED to in-flight Wave-12 trains (apply-on-approval `106`, stock-reorder `107`, HQ cadence-clock `108`) — rebase before migrate-first | in-flight |
