...
**Production `main`:** `49a0a36` — verified against `/api/health`, not inferred
**Production migration tip:** `20261097` — read from `supabase_migrations.schema_migrations`, NOT inferred
...
| `20261097` | calendar OAuth connections (`calendar_connections` + `calendar_event_links`, tokens service-role-only, composite-FK cross-org bind blocked) | **APPLIED (prod tip)** — Completion W6, #560 |
| `20261098+` | **NEXT FREE** | unallocated — re-verify against the DB before claiming |
