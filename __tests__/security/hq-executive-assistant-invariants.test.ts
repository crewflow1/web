 ...
 *   2. The executive-assistant-narrative path is DARK: the service constructs NO
 *      model SDK, reads NO vendor credential, and imports no @/lib/ai/* module, so
 *      the dark path cannot spend money. It also adds NO governor registry key (an
...
describe("Executive-Assistant AI — the narrative is dark, constructs no model SDK", () => {
